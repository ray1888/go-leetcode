...
var symtreeInOrder *datastructure.TreeNode = &datastructure.TreeNode{
	1,
...
var nonsymtreeInOrder *datastructure.TreeNode = &datastructure.TreeNode{
	1,
...
var inordertree *datastructure.TreeNode = &datastructure.TreeNode{
	3,
...
func TestInOrderTravel(t *testing.T) {
	var tests = []struct {
		...
		// Add Testcase Here
		{symtreeInOrder, [][]int{[]int{1}, []int{2, 2}, []int{3, 4, 4, 3}}},
		{nonsymtreeInOrder, [][]int{[]int{1}, []int{2, 2}, []int{3, 4, 4, 3}, []int{1}}},
		{inordertree, [][]int{[]int{3}, []int{9, 20}, []int{15, 7}}},
	}
