...
var symtreeLevel *datastructure.TreeNode = &datastructure.TreeNode{
	1,
...
var nonsymtreeLevel *datastructure.TreeNode = &datastructure.TreeNode{
	1,
...
var leveltree *datastructure.TreeNode = &datastructure.TreeNode{
	3,
...
func TestLevelTravel(t *testing.T) {
	var tests = []struct {
