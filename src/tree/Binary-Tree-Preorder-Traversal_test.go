...
var symtreePre *datastructure.TreeNode = &datastructure.TreeNode{
	1,
...
var nonsymtreePre *datastructure.TreeNode = &datastructure.TreeNode{
	1,
...
var pretree *datastructure.TreeNode = &datastructure.TreeNode{
	3,
...
func TestPreTravel(t *testing.T) {
	var tests = []struct {
		in       *datastructure.TreeNode
		expected [][]int
	}{
		// Add Testcase Here
		{symtreePre, [][]int{[]int{1}, []int{2, 2}, []int{3, 4, 4, 3}}},
		{nonsymtreePre, [][]int{[]int{1}, []int{2, 2}, []int{3, 4, 4, 3}, []int{1}}},
		{pretree, [][]int{[]int{3}, []int{9, 20}, []int{15, 7}}},
	}
